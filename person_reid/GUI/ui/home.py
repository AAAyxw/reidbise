...
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(224 ,255 ,255), stop:1 rgb(173 ,216 ,230));\n"
...
"cursor: pointer;")
        ...
        self.match_show_img.setCursor(QCursor(Qt.PointingHandCursor))
